...
<head>
    ...
    <style>
        ...
        .hero-section-bo {
            ...
            /* Couleur de fond douce pour le BO */
            padding: 80px var(--espacement-double);
            /* Moins de padding que le hero FO */
            text-align: center;
        ...
        .hero-content-bo h1 {
            ...
            /* Titre avec la couleur principale du BO */
        }
        ...
        .card-bo {
            /* Classe spécifique pour les cartes BO pour éviter conflits */
            background-color: var(--couleur-blanche);
            border: var(--bordure-standard-interface);
            border-radius: 12px;
        ...
        .cards-container {
            ...
            /* Pour l'ombre de la scrollbar si visible */
        ...
        @media (max-width: 768px) {
            ...
            /* Masquer les flèches sur mobile si le scroll est privilégié */
            .action-cards-container {
