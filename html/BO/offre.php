...
<head>
    ...
    <style>
        ...
        /* Nouveau style pour désactiver */
        .btn-toggle-on {
            background-color: #d4edda;
            color: #155724;
        }

        /* Nouveau style pour activer */
        .btn-action:hover {
            opacity: 0.8;
        }
        ...
        .main-info .status-badge.actif {
            background-color: #d4edda;
            color: #155724;
        }

        .main-info .status-badge.inactif {
            background-color: #f8d7da;
            color: #721c24;
        }
                    ...
                    <div class="details-list">
                        ...
                        <ul>
                            <li><i class="fas fa-tag"></i>
                                <div><strong>Catégorie :</strong> <?php echo htmlspecialchars(ucfirst($offer['category_type'])); ?></div>
                            </li>
                            <li><i class="fas fa-map-marker-alt"></i>
                                <div><strong>Adresse :</strong> <?php echo htmlspecialchars($offer['street'] . ', ' . $offer['postal_code'] . ' ' . $offer['city']); ?></div>
                            </li>
                            <?php if (!empty($offer['phone'])): ?>
                                <li><i class="fas fa-phone"></i>
                                    <div><strong>Téléphone :</strong> <?php echo htmlspecialchars($offer['phone']); ?></div>
                                </li>
                            <?php endif; ?>
                            <?php if (!empty($offer['website'])): ?>
                                <li><i class="fas fa-globe"></i>
                                    <div><strong>Site Web :</strong> <a href="<?php echo htmlspecialchars($offer['website']); ?>" target="_blank">Visiter le site</a></div>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
