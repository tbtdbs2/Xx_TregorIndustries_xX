    ...
    <main style="padding: 0px;">
        <section class="hero-section">
            <video autoplay muted loop playsinline id="hero-video-background">
                <source src="images/Paca.mp4" type="video/mp4">
        ...
        <section class="news-section container"> <h2>A la une</h2>
            <div class="cards-container-wrapper" id="alaUneCarouselWrapper">
                <div class="cards-container">
                    ...
                    <div class="card card-a-la-une">
                        <div class="card-image-wrapper">
                             <img src="images/randonnee.jpg" alt="Randonnée dans les Calanques">
                             <button class="favorite-btn" aria-label="Ajouter aux favoris">
                                <i class="far fa-heart"></i><i class="fas fa-heart"></i>
                            </button>
                        </div>
                    ...
                    <div class="card card-a-la-une">
                        <div class="card-image-wrapper">
                            <img src="images/gordes.jpg" alt="Visite de Gordes et Roussillon">
                            <button class="favorite-btn" aria-label="Ajouter aux favoris">
                                <i class="far fa-heart"></i><i class="fas fa-heart"></i>
                            </button>
                        </div>
                    ...
                    <div class="card card-a-la-une">
                        <div class="card-image-wrapper">
                            <img src="images/cuisine.jpg" alt="Cours de cuisine provençale"> 
                            <button class="favorite-btn" aria-label="Ajouter aux favoris">
                                <i class="far fa-heart"></i><i class="fas fa-heart"></i>
                            </button>
                        </div>
            ...
            <div class="cards-container-wrapper" id="categoriesCarouselWrapper">
                <div class="cards-container">
                    <div class="category-card">
                        <img src="images/activite.jpg" alt="Activités">
                        <h3>Activités</h3>
                    </div>
                    <div class="category-card">
                        <img src="images//visite.jpg" alt="Visites">
                        <h3>Visites</h3>
                    </div>
                    <div class="category-card">
                        <img src="images/spectacle.jpg" alt="Spectacles">
                        <h3>Spectacles</h3>
                    </div>
                    <div class="category-card">
                        <img src="images/parcs-d-attraction.jpg" alt="Parcs d'attractions">
                        <h3>Parcs d'attractions</h3>
                    </div>
                    <div class="category-card">
                        <img src="images/restaurant.jpg" alt="Restauration">
                        <h3>Restauration</h3>
                    </div>
                </div>
            ...
            <div class="cards-container-wrapper" id="destinationsCarouselWrapper">
                <div class="cards-container">
                    <div class="destination-card">
                        <img src="images/avignon.png" alt="Avignon">
                        <h3>Avignon</h3>
                    </div>
                    <div class="destination-card">
                    ...
                    <div class="destination-card">
                        <img src="images/cannes.jpg" alt="Cannes">
                        <h3>Cannes</h3>
                    </div>
                    <div class="destination-card">
                        <img src="images/toulon.jpg" alt="Toulon">
                        <h3>Toulon</h3>
                    </div>
                </div>
