...
<head>
    ...
    <title>PACT - Conditions Générales d'Utilisation</title>
    ...
    <footer>
        <div class="container footer-content">
            ...
            <div class="footer-section links">
                <h3>Ressources</h3>
                <ul>
                    <li><a href="conditions-generales-d-utilisation.php" class="active">Conditions générales d'utilisation</a></li>
